                    ...
                    <div className="py-40 xl:py-20">
                        <div className="flex xl:flex-col xl:items-center xl:justify-center justify-between items-top gap-x-11">
                            ...
                            <div className="max-w-2xl xl:text-center">
                                ...
                                <h2 className="max-w-2xl text-5xl xl:text-4xl lg:text-3xl sm:text-2xl text-black font-semibold pt-7">Transform your digital presence with our innovative marketing solutions</h2>
                                <p className="pt-10 text-lg sm:text-base">At our digital marketing agency, we understand the importance of a strong online presence. With our innovative solutions, we can help transform your digital presence and help your brand stand out in today's crowded online world. Our team of experts will work closely with you to develop a customized marketing strategy that aligns with your goals and helps you achieve the results you're looking for.</p>
                            </div>
                        </div>
                    </div>
                </div>
